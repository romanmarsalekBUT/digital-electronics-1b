...
entity tlc_speed is
  port (
    ...
    CAR_WEST: in    std_logic;
    CAR_SOUTH: in    std_logic;    
...
end entity tlc_speed;

----------------------------------------------------------
-- Architecture declaration for traffic light controller
----------------------------------------------------------

architecture behavioral of tlc_speed is
  ...
  constant c_NO_WORK  : std_logic_vector(2 downto 0) := b"000"; --! RGB settings for green color
...
begin
  ...
  begin
    ...
    if (rising_edge(clk)) then
      ...
      if (CAR_WEST='1')and(CAR_SOUTH='1') then
